...
**Correction, 2026-09-22 (restored doc).** The Asana/Monday.com example below assumes the operator
has a first-party product competing with the rival. That's superseded by the operator's direct
2026-09-19 clarification (`GeekBackend/plans/competitor-partner-data-purpose.md`): the operator has
**no product of their own** in this pipeline. Competitors are rivals to the *operator's own agency
business* (other AI-consulting/service firms), never rivals to the partner tools being promoted.
The direct/content distinction and the type-label mechanism below still hold; only the "same
product" framing of the example does not.
...
|-----------------|------------|---------|------------------------------|
| **Direct** | Rival agencies/businesses competing for the same clients | one AI-consulting firm vs another | Comparison / positioning content to win prospects choosing between service providers |
| **Content** | Entities that don't sell your product but compete for the same audience's attention in search | a rival agency vs an industry publication | Analyze SEO authority and coverage to rank for broad industry terms |
