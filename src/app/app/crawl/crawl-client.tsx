  ...
  return (
    <div className="mt-8 space-y-6">
      <div className="flex flex-col gap-3">
        ...
        {/* Not indexed here means "not crawled yet", and this page is where that is fixed -- so it
            reports, it does not block. Partner and competitor are different: nothing on this page
            resolves those, and a create cannot cite them. */}
        <IndexReport
          urls={parseLines(domain)}
          results={indexed}
