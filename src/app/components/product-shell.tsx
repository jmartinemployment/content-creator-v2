...
export function ProductShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[var(--cc-paper)] md:grid md:grid-cols-[244px_1fr]">
      ...
      <nav
        className="fixed inset-x-0 bottom-0 z-30 grid grid-cols-6 border-t border-[var(--cc-line)] bg-white px-2 pb-[max(.5rem,env(safe-area-inset-bottom))] pt-2 md:hidden"
